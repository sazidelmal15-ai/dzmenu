...
export function RestaurantLifecycleActions({
  restaurant,
  onActionSuccess,
}: RestaurantLifecycleActionsProps) {
    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs">
        ...
        <button
          ...
          className="flex flex-col items-center justify-center gap-1.5 p-2.5 rounded-xl border border-zinc-200/80 bg-zinc-50 hover:bg-zinc-100/80 text-zinc-800 font-medium transition cursor-pointer shadow-2xs"
        >
          <Zap className="h-4 w-4 text-amber-500" />
          <span className="text-[11px]">Activate Plan</span>
        </button>
        ...
        >
          ...
          <span className="text-[11px]">Grant Trial</span>
        </button>
        ...
        {isSuspended ? (
          <button
            ...
            className="flex flex-col items-center justify-center gap-1.5 p-2.5 rounded-xl border border-emerald-200 bg-emerald-50 hover:bg-emerald-100/80 text-emerald-800 font-medium transition cursor-pointer shadow-2xs"
          >
            <RotateCcw className="h-4 w-4 text-emerald-600" />
            <span className="text-[11px]">Reactivate</span>
          </button>
        ) : (
          <button
            type="button"
            onClick={() => openModal("suspend")}
            className="flex flex-col items-center justify-center gap-1.5 p-2.5 rounded-xl border border-rose-200 bg-rose-50 hover:bg-rose-100/80 text-rose-800 font-medium transition cursor-pointer shadow-2xs"
          >
            ...
            <form onSubmit={handleActivatePlan} className="space-y-3.5">
                      ...
                      >
                        ...
                        <span
                          className={`text-[11px] font-mono mt-1 ${
                            isPicked ? "text-zinc-300" : "text-zinc-500"
                          }`}
                        >
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Offline payment confirmation #3910"
            ...
            <form onSubmit={handleExtendSubscription} className="space-y-3.5">
              ...
              <div>
                ...
                <input
                  ...
                  value={reason}
                  onChange={(e) => setReason(e.target.value)}
                  placeholder="e.g. Loyalty extension / Offline receipt"
                  className="w-full px-3 py-1.5 text-xs bg-zinc-50 border border-zinc-200 rounded-lg text-zinc-900 focus:outline-none focus:border-zinc-900"
                />
              </div>
            ...
            <form onSubmit={handleSuspendRestaurant} className="space-y-3.5">
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => setReason(e.target.value)}
                  rows={2}
                  placeholder="Mandatory reason for audit trail (e.g. Terms violation, payment dispute)..."
