...
export const QrStudioSettingsSchema = z.object({
  foregroundColor: z.string().regex(/^#([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/, "Invalid hex color").default("#000000"),
  ...
  logoSize: z.number().min(15).max(35).default(20), // percentage of QR size
